...
try {
    ...
    function Get-ModelName($sku) {
        switch ($sku) {
            "Surface_Pro_1796" {"Surface Pro 5"}
            "Surface_Pro_1807" {"Surface Pro 5 LTE Advanced"}
            "Surface_Pro_6_1796_Commercial" {"Surface Pro 6 Commercial"}
            "Surface_Pro_6_1796_Consumer" {"Surface Pro 6 Consumer"}
            "Surface_Pro_7_1866" {"Surface Pro 7"}
            "Surface_Pro_7+_1960" {"Surface Pro 7+"}
            "Surface_Pro_7+_with_LTE_Advanced_1961" {"Surface Pro 7+ LTE"}
            "Surface_Pro_8_for_Business_1983" {"Surface Pro 8 for Business"}
            "Surface_Pro_8_1983" {"Surface Pro 8 Consumer"}
            "Surface_Pro_8_for_Business_with_LTE_Advanced_1982" {"Surface Pro Pro 8 LTE for Business"}
            "Surface_Pro_9_2038" {"Surface Pro 9"}
            "Surface_Pro_9_for_Business_2038" {"Surface Pro 9 for Business"}
            "Surface_Pro_9_With_5G_1996" {"Surface Pro 9 with 5G"}
            "LENOVO_MT_11LV_BU_Think_FM_ThinkCentre M60e" {"LENOVO ThinkCentre M60e"}
            default {"Not listed - `r`n $sku"}
        }
    }
    ...
    $info = @(
        ...
        # ""
        # "$($processorNameShort)"
        # "$($cs.TotalPhysicalMemory / 1GB -as [int]) GB"
        # "${diskSizeGB} GB"
    )
